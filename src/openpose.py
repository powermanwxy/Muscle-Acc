...
if platform == "win32":
    os.environ['PATH'] = dir_path + "/../libraries/openpose/bin;" + os.environ['PATH']
    os.environ['PATH'] = dir_path + "/../libraries/openpose/x64/Debug;" + os.environ['PATH']
    os.environ['PATH'] = dir_path + "/../libraries/openpose/x64/Release;" + os.environ['PATH']
